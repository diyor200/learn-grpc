...
type HelloResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	HelloText     string                 `protobuf:"bytes,1,opt,name=helloText,proto3" json:"helloText,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *HelloResponse) GetHelloText() string {
	if x != nil {
		return x.HelloText
	}
	return ""
...
const file_hello_proto_rawDesc = "" +
	...
	"\rHelloResponse\x12\x1c\n" +
	"\thelloText\x18\x01 \x01(\tR\thelloText2>\n" +
	"\x05Hello\x125\n" +
	"\bSayHello\x12\x13.hello.HelloRequest\x1a\x14.hello.HelloResponseB\x12Z\x10hello.v1;hellov1b\x06proto3"
