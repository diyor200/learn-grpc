...
const file_file_upload_proto_rawDesc = "" +
	...
	"\rCheckResponse\x12\"\n" +
	"\fuploadedSize\x18\x01 \x01(\x03R\fuploadedSize2\x94\x01\n" +
	"\vFileService\x12B\n" +
	"\tCheckFile\x12\x18.fileupload.CheckRequest\x1a\x19.fileupload.CheckResponse\"\x00\x12A\n" +
	"\n" +
...
var file_file_upload_proto_goTypes = []any{
	...
	(*CheckRequest)(nil),  // 2: fileupload.CheckRequest
	(*CheckResponse)(nil), // 3: fileupload.CheckResponse
}
var file_file_upload_proto_depIdxs = []int32{
	2, // 0: fileupload.FileService.CheckFile:input_type -> fileupload.CheckRequest
	0, // 1: fileupload.FileService.FileUpload:input_type -> fileupload.FileChunk
	3, // 2: fileupload.FileService.CheckFile:output_type -> fileupload.CheckResponse
	1, // 3: fileupload.FileService.FileUpload:output_type -> fileupload.UploadStatus
